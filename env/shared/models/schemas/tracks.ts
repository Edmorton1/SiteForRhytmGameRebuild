import {LanguagesCode, languagesCodes} from '../enums/countries';
import {IsEnumArray, IsId, TransformDefault} from '../enums/decorators';
import {IsBoolean, isEnum, IsEnum, IsInt, isISO31661Alpha2, IsISO31661Alpha2, IsNumber, IsOptional, IsPositive, IsString, MaxLength, Min, registerDecorator, ValidateNested} from 'class-validator';
